...
List<NBATeam> NBATeams = [
  ...
  NBATeam(
      ...
      url: "http://www.nba.com/teams/nets"),
  NBATeam(
      id: 4,
      name: "Hornets",
      city: "Charlotte",
      ...
      url: "http://www.nba.com/teams/hornets"),
        NBATeam(
      id: 5,
      name: "Bulls",
      city: "Chicago",
      ...
      url: "http://www.nba.com/teams/bulls"),
  NBATeam(
      id: 6,
      name: "Cavaliers",
      city: "Cleveland",
  ...
  NBATeam(
      ...
      url: "http://www.nba.com/teams/pacers"),
  NBATeam(
      id: 13,
      name: "Clippers",
      city: "Los Angeles",
  ...
  NBATeam(
      ...
      url: "http://www.nba.com/teams/heat"),
  NBATeam(
      id: 17,
      name: "Bucks",
      city: "Milwaukee",
      ...
      url: "http://www.nba.com/teams/bucks"),
  NBATeam(
      id: 18,
      name: "Timberwolves",
      city: "Minnesota",
      ...
      url: "http://www.nba.com/teams/timberwolves"),
  NBATeam(
      id: 19,
      name: "Pelicans",
      city: "New Orleans",
      ...
      color: HexColor("002B5C"),
      url: "http://www.nba.com/teams/pelicans"),
  NBATeam(
      id: 20,
      name: "Knicks",
      city: "New York",
  ...
  NBATeam(
      ...
      url: "http://www.nba.com/teams/thunder"),
  NBATeam(
      id: 22,
      name: "Magic",
      city: "Orlando",
  ...
  NBATeam(
      ...
      color: HexColor("006BB6"),
      url: "http://www.nba.com/teams/sixers"),
  NBATeam(
      id: 24,
      name: "Suns",
      city: "Phoenix",
      ...
      url: "http://www.nba.com/teams/suns"),
  NBATeam(
      id: 25,
      name: "Trail Blazers",
      city: "Portland",
      ...
      url: "http://www.nba.com/teams/blazers"),
  NBATeam(
      id: 26,
      name: "Kings",
      city: "Sacramento",
      ...
      url: "http://www.nba.com/teams/kings"),
  NBATeam(
      id: 27,
      name: "Spurs",
      city: "San Antonio",
      ...
      url: "http://www.nba.com/teams/spurs"),
  NBATeam(
      id: 28,
      name: "Raptors",
      city: "Toronto",
      ...
      color: HexColor("CE1141"),
      url: "http://www.nba.com/teams/raptors"),
  NBATeam(
      id: 29,
      name: "Jazz",
      city: "Utah",
      ...
      color: HexColor("00471B"),
      url: "http://www.nba.com/teams/jazz"),
  NBATeam(
      id: 30,
      name: "Wizards",
      city: "Washington",
